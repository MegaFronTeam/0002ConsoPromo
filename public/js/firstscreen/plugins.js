...
function FitThumbScreen() {
	...
	for (
		var e = document.documentElement,
			t = document.body,
			o = document.querySelectorAll(".thumb-page"),
			i = document.querySelectorAll(".item-image"),
			n = document.querySelectorAll(".item-content"),
			a = 0;
		a < i.length;
		a++
	)
	...
	function l(e, t, o) {
		o.addEventListener("click", function () {
			TweenMax.to("#ball", 0.3, {
				...
				setTimeout(function () {
					TweenMax.to(
						"#hero, .item-content, .item .item-caption, #page-nav, footer",
						0.4,
						{
							opacity: 0,
							delay: 0.1,
	...
	function c(e, o) {
		var i = e.cloneNode(!0),
			n = d(e),
			a = d(o);
		TweenLite.set([e, o], {visibility: "hidden"}),
			TweenLite.set(i, {position: "absolute", margin: 0}),
			t.appendChild(i);
		var l = {
			x: a.left - n.left,
			y: a.top - n.top,
...
function FitSlideScreen() {
	...
	for (
		var a = document.documentElement,
			s = document.body,
			e = document.querySelectorAll(".thumb-page"),
			t = document.querySelectorAll(".section-image"),
			i = 0;
		i < t.length;
		i++
	)
	...
	function o(e, t) {
		e.addEventListener("click", function () {
			TweenMax.to("#ball", 0.2, {borderWidth: "2px", scale: 1, x: -15, y: -15}),
				...
				TweenMax.to(
					".swiper-slide .section-image, .swiper-slide .carousel-caption, footer",
					0.4,
					{
						opacity: 0,
						delay: 0.2,
			...
			t.addEventListener("click", function () {
				$(".swiper-slide").removeClass("above"),
					TweenMax.to(
						".swiper-slide .section-image, .swiper-slide .carousel-caption, footer",
						0.3,
						{opacity: 1, delay: 0.6, ease: Power2.easeOut}
					),
					n(t, e);
			});
	}
	function n(e, t) {
		var i = e.cloneNode(!0),
			o = d(e),
			n = d(t);
		TweenLite.set([e, t], {visibility: "hidden"}),
			TweenLite.set(i, {position: "absolute", margin: 0}),
			s.appendChild(i);
		var l = {
			x: n.left - o.left,
